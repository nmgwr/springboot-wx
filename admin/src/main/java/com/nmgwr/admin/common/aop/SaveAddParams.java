...
import com.nmgwr.admin.common.utils.StringUtil;
...
public class SaveAddParams {
    ...
    /**
     * 扫描所有Controller下方法名为save的方法，在新增的时候初始化createUser、updateUser、createDate、updateDate、id这些参数
     * @param pjp
     * @return
     * @throws Throwable
     */
    @Around("execution(* com.nmgwr..*Controller.save(..))")
    public Object saveAddParams(final ProceedingJoinPoint pjp)throws Throwable{
        try {
            ...
            json.put("id",StringUtil.getUUID32());
